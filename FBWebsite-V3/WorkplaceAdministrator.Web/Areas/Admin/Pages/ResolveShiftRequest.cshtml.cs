...
namespace WorkplaceAdministrator.Web.Areas.Admin.Pages
{
    ...
    public class ResolveShiftRequestModel : AdminPageModel
    {
        ...
        private async Task<ShiftRequestAlert> LoadAlertForResolution(int alertId)
        {
            ...
            // load users
            if (selectedAlert.OldShift.Volunteer != null)
            {
        ...
        private void ResolveRecurringShiftDisplay()
        {
            ...
            bool requestedShiftIsPartOfRecurringSet = ShiftRequest.NewShift.ParentRecurringShift != null;
