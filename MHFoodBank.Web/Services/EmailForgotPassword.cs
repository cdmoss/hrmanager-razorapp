...
namespace MHFoodBank.Web.Services
{
    ...
    {
        Task SendForgotPasswordEmailAsync(string email, HttpRequest request, IUrlHelper url);
    }
    public class PasswordRecoveryService : IPasswordRecoveryService
    {
        ...
        public PasswordRecoveryService(UserManager<AppUser> userManager, IEmailSender emailSender)
        {
            _userManager = userManager;
            _emailSender = emailSender;
        }

        public async Task SendForgotPasswordEmailAsync(string email, HttpRequest request, IUrlHelper url)
        {
