...
namespace MHFoodBank.Web.Data.Models
{
    ...
    public class RecurringShift : Shift
    {
        ...
        public void UpdateRecurrenceRule()
        {
            ...
            // rrule converts the end date into utc, so a one day offset is applied, see line 316 in in AdminCalendar.cshtml
            string endDateStr = EndDate.AddDays(1).ToString("yyyyMMdd");
            string exDateStr = "";
